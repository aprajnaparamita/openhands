    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 mt-auto transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Decentralized commission platform empowering artists and clients with secure, transparent transactions.
            </p>
          </div>

          {/* Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Platform</h4>
            <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-sm">
              <li><Link to="/browse-artists" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Browse Artists</Link></li>
              <li><Link to="/browse-projects" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Browse Projects</Link></li>
              <li><Link to="/profile/setup" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Become a Creator</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-12 pt-8 text-center text-gray-500 dark:text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} OpenHands. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
